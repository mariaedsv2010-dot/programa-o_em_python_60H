...
cacto1 = pygame.image.load('assets\\cacto.png')
cacto2 = pygame.image.load('assets\\cobra.png')
    ...
    if not game_over:
       ...
       if trex_y >=300:
          ...
          if cacto_x < -50:
             ...
             cacto_rect = cacto1.get_rect(topleft = (cacto_x,cacto_y))
             ...
             tela.blit(cacto1,(cacto_x,cacto_y))

             #pontuação

             texto = fonte.render('Pontuacao' + str(score), True(0,0,0))
...
trex1 =  pygame.image.load('assets/1.png')
trex2 =  pygame.image.load('assets/2.png')
trex3 =  pygame.image.load('assets/3.png')

cacto_img1 = pygame.image.load('assets/cacto.png')
cacto_img2 = pygame.image.load('assets/cacto2.png') 

chao =  pygame.image.load('assets/ground.jpg')
